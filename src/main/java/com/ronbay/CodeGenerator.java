...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/src/main/java/com/ronbay");
        gc.setAuthor("Yunpeng zhang");
        gc.setOpen(false);
...
//        gc.setEntityName("%sEntity");			//实体命名方式  默认值：null 例如：%sEntity 生成 UserEntity
        ...
        dsc.setUrl("jdbc:mysql://aws003.infwaves.com:3306/erp-purchase?useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//        String templatePath = "/templates/mapper.xml.ftl";
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/src/main/java/map"+pc.getModuleName()
...
//        strategy.setSuperEntityColumns("id");
        strategy.setInclude(("REPAIR_ORDER_OP_LOG").split(","));
